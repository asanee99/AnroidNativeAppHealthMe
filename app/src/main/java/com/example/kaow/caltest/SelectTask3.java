 ...
 */
public class SelectTask3 extends AsyncTask<Void, Void, String> {


    private Context mContext;
    private String mUrl;

    public SelectTask3(Context context, String url) {
        super();
        mUrl = url;
        mContext = context;
        ...
        try {
            ...
            if (success == 1) {
                ...
                for (int i = 0; i < food.length(); i++) {
                    ...
                    ((ShowFoodMid) mContext).list.setAdapter(adapter);
                }
            } else if (success == 0) {
                ((ShowFoodMid) mContext).list.setAdapter(null);
