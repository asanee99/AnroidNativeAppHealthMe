 ...
 */
public class ShowFoodUp extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener  {
    ...
    private void getAlldata() {
        ...
        String url = "http://55118020115.msci.dusit.ac.th/showFoodUp.php";
